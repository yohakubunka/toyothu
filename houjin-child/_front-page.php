        ...
        <div class="page-width">
            <div class="houjin-info__content">
                ...
                <div class="houjin-info__content--about">
                    ...
                    <div class="about-box bg-radius box-b">
                        ...
                        <dl>
                            ...
                            <dd class="address n-txt_m"><a href="https://goo.gl/maps/ZfqefVcr8yiCw2SX8" target="_blank" rel="noopener"><?= $theme_options['op_2'] ?> <br class="brsp"><?= $theme_options['op_3'] ?>　<br class="brsp">ゆたか認定こども園内<img src="<?= get_theme_file_uri() ?>/images/icon_map.png" alt="マップアイコン" width="20px" height="26px"></a></dd>
                        </dl>
                        <dl>
                ...
                <?php endif;
                        wp_reset_postdata(); //クエリのリセット
                ?>
                <p class="annotation n-txt_m"><?= get_theme_mod('houjin_info_caution'); ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="page-width">
            <div class="houjin-contact__content">
                ...
                <div class="houjin-contact__content--form box-b">
                    <?= do_shortcode('[contact-form-7 id="61" title="お問い合わせ"]') ?>
                </div>
            </div>
        </div>
    </section>
