  ...
  <nav class="globalMenuSp">
    <div class="overflow">
      <ul class="bg-brown">
        <div class="nav-flex">
          <li class="head-link">
            <a class="contact-button" href="<?= home_url() ?>/#section-olive-contact">
        ...
        <li class="head-link n-txt_b">
          <a class="left-line" href="<?= home_url() ?>/#section-olive-news">お知らせ</a>
        </li>
        <li class="head-link n-txt_b">
          <a class="left-line" href="<?= home_url() ?>/#section-olive-content">療育内容</a>
        </li>
        <li class="head-link n-txt_b">
          <a class="left-line" href="<?= home_url() ?>/#section-olive-use">ご利用にあたって</a>
        </li>
        <li class="head-link n-txt_b">
          <a class="left-line" href="<?= home_url() ?>/#section-olive-option">施設概要</a>
        </li>
      </ul>
      ...
      <ul class="bg-black">
        ...
        <li class="head-link n-txt_b white">
          <a class="left-line_white alert-btn" href="https://toyotsujidou.com/#section-houjin-facility" target="_blank">施設一覧</a>
        </li>
        <li class="head-link n-txt_b white">
          <a class="left-line_white" href="https://toyotsujidou.com/recruitment/" target="_blank" rel="noopener">採用情報</a>
        </li>
      </ul>
    </div>
  </nav>
